...
namespace JustGo.Result.Application.Features.ResultView.Queries.GetEvents.GetGymnasticEvents;

public class GymnasticEventsQueryProcessor : BaseEventsQueryProcessor
{
    public GymnasticEventsQueryProcessor(
    ...
    {
        return "COUNT(DISTINCT UserId) AS TotalParticipants";
    }

    protected override string GetSelectColumns()
    {
        return "COALESCE(pc.TotalParticipants, 0) AS TotalParticipants";
    }
