...
public class GetMfaByUserGuidQueryHandler : IRequestHandler<GetMfaByUserGuidQuery, UserMFA>
{
    private readonly LazyService<IReadRepository<UserMFA>> _readRepository;
    private readonly IUtilityService _utilityService;
    public GetMfaByUserGuidQueryHandler(LazyService<IReadRepository<UserMFA>> readRepository, IUtilityService utilityService)
    {
        _readRepository = readRepository;
        _utilityService = utilityService;
    }

    public async Task<UserMFA> Handle(GetMfaByUserGuidQuery request, CancellationToken cancellationToken)
    {
        string sql = @"
                        ...
                        select Top 1 AuthenticatorKey,EnableAuthenticatorApp,
                        EnableWhatsapp,
