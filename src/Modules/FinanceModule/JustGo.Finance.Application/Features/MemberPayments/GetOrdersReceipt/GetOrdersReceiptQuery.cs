...
{
    public class GetOrdersReceiptQuery : PaginationDateRangeFilter, IRequest<PaymentInfoVM>
    {
        public GetOrdersReceiptQuery(Guid merchantId, DateTime? fromDate, DateTime? toDate,
