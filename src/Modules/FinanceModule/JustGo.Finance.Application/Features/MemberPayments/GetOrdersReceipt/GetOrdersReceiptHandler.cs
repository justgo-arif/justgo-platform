...
{
    public class GetOrdersReceiptHandler : IRequestHandler<GetOrdersReceiptQuery, PaymentInfoVM>
    {
        private readonly LazyService<IReadRepository<PaymentInfoDto>> _readRepository;
        private readonly IMediator _mediator;
        public GetOrdersReceiptHandler(LazyService<IReadRepository<PaymentInfoDto>> readRepository, IMediator mediator)
        {
            _readRepository = readRepository;
            _mediator = mediator;
        }

        public async Task<PaymentInfoVM> Handle(GetOrdersReceiptQuery request, CancellationToken cancellationToken)
        {
