...
namespace JustGo.AssetManagement.Application.Features.AssetRegisters.Queries.GetMyAssets
{
    ...
    public class GetMyAssetsHandler : IRequestHandler<GetMyAssetsQuery, PagedResult<AssetListItemDTO>>
    {
        private readonly IMediator _mediator;
        private readonly IReadRepositoryFactory _readRepository;
        private readonly IMapper  _mapper;
        private readonly IUtilityService _utilityService;
        public GetMyAssetsHandler(
            IMediator mediator,
        ...
        public async Task<PagedResult<AssetListItemDTO>> Handle(GetMyAssetsQuery request, CancellationToken cancellationToken)
        {
        ...
        private async Task<PagedResult<AssetDTOWithRawData>> FetchRawData(GetMyAssetsQuery request, CancellationToken cancellationToken)
        {
            ...
            string searchSql = $@" Where 
                    ((ast.AssetStatusId = 1 and ao.OwnerId = @CurrentUserId)
                     or ast.AssetStatusId != 1)
                     And
                    (aosp.EntityType = 1 or (lst.Name = 'Active' and aosp.EntityType = 2))
                     And
            ...
            dataSql1 = $@"WITH
                        ...
                        Assets as (
                              SELECT
                               ...
                               @"Inner Join  AssetOwnerships aosp on aosp.AssetId = ar.AssetId and aosp.OwnerType != 3 and aosp.EntityType <= 2
                                INNER JOIN [User] u ON u.UserId = aosp.OwnerId " +
